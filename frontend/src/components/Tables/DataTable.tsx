    ...
    return (
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <DataTable value={computers} rows={500} filters={filters}
                ...
                globalFilterFields={["departament.name", "section.name",  "user", "type_compyuter.name", "ipadresss"]} rowClassName={() => "border border-gray-300"} className="p-3 table-border">
                ...
                <Column field="section.name" header="Отдел" filter filterPlaceholder="Поиск по отдела" showFilterMenuOptions={false} showApplyButton={false} showClearButton={false} headerStyle={{ fontWeight: 'bold', border: "1px solid #c8c5c4", textAlign: 'center', padding: "10px", color: "black" }} />
